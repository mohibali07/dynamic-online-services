				...
				'show_in_rest' => array(
					'schema' => array(
						...
						'properties' => array(
							...
							'whatsapp_visibility' => array( 'type' => 'string' ),
							'whatsapp_availability' => array( 'type' => 'boolean' ),
							'whatsapp_schedule_start' => array( 'type' => 'string' ),
							'whatsapp_schedule_end' => array( 'type' => 'string' ),
							'whatsapp_timezone' => array( 'type' => 'string' ),
							'whatsapp_position_offset_x' => array( 'type' => 'string' ),
							'whatsapp_position_offset_y' => array( 'type' => 'string' ),
							'whatsapp_icon_style' => array( 'type' => 'string' ),
							'whatsapp_show_desktop' => array( 'type' => 'boolean' ),
							'whatsapp_show_mobile' => array( 'type' => 'boolean' ),
							'whatsapp_analytics_enabled' => array( 'type' => 'boolean' ),
							'whatsapp_offline_behavior' => array( 'type' => 'string' ),
							'whatsapp_offline_text' => array( 'type' => 'string' ),
							'whatsapp_cta_enabled' => array( 'type' => 'boolean' ),
							'whatsapp_cta_text' => array( 'type' => 'string' ),
							'whatsapp_cta_delay' => array( 'type' => 'string' ), // numeric string
							'whatsapp_agents_enabled' => array( 'type' => 'boolean' ),
