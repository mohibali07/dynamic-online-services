...
function dynos_settings_page_html(): void {
	if ( class_exists( '\TechmireSolutions\DynamicOnlineServices\Settings\PageRenderer' ) ) {
...
function dynos_render_flush_rewrite_section(): void {
	if ( class_exists( '\TechmireSolutions\DynamicOnlineServices\Settings\PageRenderer' ) ) {
		\TechmireSolutions\DynamicOnlineServices\Settings\PageRenderer::render_flush_rewrite_section();
	}
}
...
function dynos_render_uninstall_settings(): void {
	if ( class_exists( '\TechmireSolutions\DynamicOnlineServices\Settings\PageRenderer' ) ) {
		\TechmireSolutions\DynamicOnlineServices\Settings\PageRenderer::render_uninstall_settings();
	}
}
