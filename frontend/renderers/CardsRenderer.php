...
class CardsRenderer implements RendererInterface
{
	...
	public function render(array $data): string
	{
		...
		$default_min_width = \TechmireSolutions\DynamicOnlineServices\Core\Configuration::get_grid_min_width();
		$min_cols = \TechmireSolutions\DynamicOnlineServices\Core\Configuration::get_min_grid_columns();
		$max_cols = \TechmireSolutions\DynamicOnlineServices\Core\Configuration::get_max_grid_columns();
