...
class Category {
	...
	protected function load_dependencies(): void {
		if ( defined( 'DYNOS_PLUGIN_DIR' ) ) {
			if ( ! function_exists( 'dynos_validate_category_shortcode_attributes' ) ) {
				require_once DYNOS_PLUGIN_DIR . 'frontend/shortcodes/category/validation.php';
			}
			if ( ! function_exists( 'dynos_get_category_shortcode_child_categories' ) ) {
				require_once DYNOS_PLUGIN_DIR . 'frontend/shortcodes/category/query.php';
			}
			if ( ! function_exists( 'dynos_render_category_shortcode_items' ) ) {
				require_once DYNOS_PLUGIN_DIR . 'frontend/shortcodes/category/renderer.php';
			}
			if ( ! function_exists( 'dynos_get_pagination_html' ) ) {
				require_once DYNOS_PLUGIN_DIR . 'frontend/shortcodes/category/pagination.php';
			}
		}
	}
}
