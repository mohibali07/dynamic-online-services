<?php
/**
 * Service Cards Settings Registration
 *
 * Handles registration of service cards settings fields.
 *
...
/**
 * Register service cards settings.
 *
 * @since 1.1.0
 */
function doc_register_cards_settings(): void {
    // Card Colors
    add_settings_field(
        'card_bg_color',
        __('Card Background Color', 'dynamic-online-services'),
        'doc_color_field_callback',
    ...
    add_settings_field(
        ...
        'doc_font_family_field_callback',
        'Dynamic_Online_Services',
        'doc_cards_section',
        array(
