<?php
/**
 * FAQ Accordion Settings Registration
 *
 * Handles registration of FAQ accordion settings fields.
 *
...
/**
 * Register FAQ accordion settings.
 *
 * @since 1.1.0
 */
function doc_register_faq_settings(): void {
    // FAQ Colors
    add_settings_field(
