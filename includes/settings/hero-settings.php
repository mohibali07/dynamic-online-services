<?php
/**
 * Hero Section Settings Registration
 *
 * Handles registration of hero section settings fields.
 *
 ...
 * @since 1.1.0
 */
function doc_register_hero_settings(): void {
    // Hero Colors
    add_settings_field(
        'hero_title_color',
