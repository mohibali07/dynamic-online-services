...
class PageRenderer
{
	...
	public static function render(): void
	{
		...
		echo '<div id="dynos-settings-root"></div>';
	}
			...
			<fieldset>
				<label for="dynos_delete_data_on_uninstall">
					<input type="checkbox" id="dynos_delete_data_on_uninstall" name="dynos_options[delete_data_on_uninstall]"
						value="1" <?php checked(1, \DynamicOnlineServices\Helpers\Options::get_option(\DynamicOnlineServices\Helpers\Options::get(), 'delete_data_on_uninstall', 0)); ?>>
