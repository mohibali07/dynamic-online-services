 ...
 */
function dynos_add_service_category_custom_fields($taxonomy): void
{
 ...
 */
function dynos_edit_service_category_custom_fields($term): void
{
	wp_nonce_field('dynos_service_category_fields', 'dynos_service_category_fields_nonce');
...
function dynos_init_service_category_fields_renderer(): void
{
	...
	add_action($taxonomy_slug . '_edit_form_fields', 'dynos_edit_service_category_custom_fields', 10, 1);
}
add_action('init', 'dynos_init_service_category_fields_renderer');
