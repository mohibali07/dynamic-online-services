 ...
 */
function dynos_get_placeholder_image_url($size = 'full'): string
{
 ...
 */
function dynos_get_service_banner_image($post_id): array
{
	...
	$image_array = dynos_get_acf_field('banner_bg_image', $post_id, array());
 ...
 */
function dynos_get_service_description($post_id): string
{
	$post_id = absint($post_id);
	if (0 === $post_id) {
		return '';
	...
	$description = dynos_get_acf_field('banner_description', $post_id, '');
