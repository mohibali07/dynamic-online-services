...
function dynos_load_plugin_files(): void
{
	...
	require_once DYNOS_PLUGIN_DIR . 'includes/core/exception.php';
	require_once DYNOS_PLUGIN_DIR . 'includes/core/error-handler.php';
	...
	require_once DYNOS_PLUGIN_DIR . 'includes/post-types.php';
	require_once DYNOS_PLUGIN_DIR . 'includes/taxonomy-fields.php';
	require_once DYNOS_PLUGIN_DIR . 'includes/faqs-meta-box.php';
	require_once DYNOS_PLUGIN_DIR . 'includes/shortcodes-faqs.php';
	require_once DYNOS_PLUGIN_DIR . 'includes/shortcodes-category.php';
	require_once DYNOS_PLUGIN_DIR . 'includes/shortcodes-hero.php';
