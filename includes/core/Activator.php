	...
	public static function activate(): void {
		try {
			...
			if ( ! function_exists( 'dynos_handle_activation_error' ) ) {
				...
				if ( file_exists( $plugin_dir . 'includes/core/PluginException.php' ) ) {
					require_once $plugin_dir . 'includes/core/PluginException.php';
				}
				if ( file_exists( $plugin_dir . 'includes/core/ErrorHandler.php' ) ) {
					require_once $plugin_dir . 'includes/core/ErrorHandler.php';
				}
			}
