...
namespace DynamicOnlineServices\Services;
...
class SettingsService
{
	...
	private function __construct()
	{
		...
		$this->options = \DynamicOnlineServices\Helpers\Options::get();
	}
	...
	{
		return \DynamicOnlineServices\Helpers\Options::get_option($this->options, $key, $default);
	}
