...
var _NNJG45OFcjs = require('../__chunks/NNJG45OF.cjs');
require('../__chunks/GDZQUFNP.cjs');


var _LT33CJGTcjs = require('../__chunks/LT33CJGT.cjs');
...
function createTabStore({
  ...
  const panels = _LT33CJGTcjs.createCollectionStore.call(void 0, );
  const initialState = {
    ...composite.getState(),
