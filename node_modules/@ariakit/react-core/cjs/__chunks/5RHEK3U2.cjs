...
var _QJGTENWIcjs = require('./QJGTENWI.cjs');
...
function useCollectionRenderer({
  ...
  var _a, _b;
  const context = _QJGTENWIcjs.useCollectionContext.call(void 0, );
  store = store || context;
  const items = _EMYYI4CZcjs.useStoreState.call(void 0, 
    store,
  ...
  const baseId = _MZ2HG624cjs.useId.call(void 0, props.id);
  const horizontal = orientation === "horizontal";
  const elements = _react.useMemo.call(void 0, () => /* @__PURE__ */ new Map(), []);
  const [elementsUpdated, updateElements] = _MZ2HG624cjs.useForceUpdate.call(void 0, );
  ...
  const processVisibleIndicesEvent = _MZ2HG624cjs.useEvent.call(void 0, processVisibleIndices);
  _react.useEffect.call(void 0, () => {
  ...
  const renderOnScrollProp = _MZ2HG624cjs.useBooleanEvent.call(void 0, renderOnScroll);
  _react.useEffect.call(void 0, () => {
  ...
  const renderOnResizeProp = _MZ2HG624cjs.useBooleanEvent.call(void 0, renderOnResize);
  _react.useEffect.call(void 0, () => {
...
var CollectionRenderer = _WBFXWJUHcjs.forwardRef.call(void 0, function CollectionRenderer2(props) {
