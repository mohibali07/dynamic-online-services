...
var useCompositeHover = _WBFXWJUHcjs.createHook.call(void 0, 
  function useCompositeHover2({
    ...
    const focusOnHoverProp = _MZ2HG624cjs.useBooleanEvent.call(void 0, focusOnHover);
    ...
    const blurOnHoverEndProp = _MZ2HG624cjs.useBooleanEvent.call(void 0, blurOnHoverEnd);
    const onMouseLeave = _MZ2HG624cjs.useEvent.call(void 0, (event) => {
      var _a;
...
var CompositeHover = _WBFXWJUHcjs.memo.call(void 0, 
  _WBFXWJUHcjs.forwardRef.call(void 0, function CompositeHover2(props) {
