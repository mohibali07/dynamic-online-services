...
var _QXXNZT2Icjs = require('./QXXNZT2I.cjs');
...
var usePopover = _WBFXWJUHcjs.createHook.call(void 0, 
  function usePopover2({
    ...
    const context = _QXXNZT2Icjs.usePopoverProviderContext.call(void 0, );
    store = store || context;
    _misc.invariant.call(void 0, 
      store,
    ...
    const getAnchorRectProp = _MZ2HG624cjs.useEvent.call(void 0, getAnchorRect);
    const updatePositionProp = _MZ2HG624cjs.useEvent.call(void 0, updatePosition);
    ...
    props = _MZ2HG624cjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _QXXNZT2Icjs.PopoverScopedContextProvider, { value: store, children: element }),
      [store]
    );
    props = {
    ...
    props = _7PVRUA4Ccjs.useDialog.call(void 0, {
      store,
      modal,
      portal,
      preserveTabOrder,
...
var Popover = _7PVRUA4Ccjs.createDialogComponent.call(void 0, 
  _WBFXWJUHcjs.forwardRef.call(void 0, function Popover2(props) {
    const htmlProps = usePopover(props);
    return _WBFXWJUHcjs.createElement.call(void 0, TagName, htmlProps);
  }),
  _QXXNZT2Icjs.usePopoverProviderContext
);
