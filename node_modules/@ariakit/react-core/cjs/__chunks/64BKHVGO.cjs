...
function useKeyboardEventProxy(store, onKeyboardEvent, previousElementRef) {
  return _MZ2HG624cjs.useEvent.call(void 0, (event) => {
    var _a;
...
var useComposite = _WBFXWJUHcjs.createHook.call(void 0, 
  function useComposite2({
    ...
    const context = _GCJBB4ZTcjs.useCompositeProviderContext.call(void 0, );
    store = store || context;
    ...
    const [, setBaseElement] = _MZ2HG624cjs.useTransactionState.call(void 0, 
    ...
    const onFocusCapture = _MZ2HG624cjs.useEvent.call(void 0, (event) => {
    ...
    props = _MZ2HG624cjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _GCJBB4ZTcjs.CompositeContextProvider, { value: store, children: element }),
      [store]
    );
    ...
    props = {
      ...
      ...props,
      ref: _MZ2HG624cjs.useMergeRefs.call(void 0, ref, setBaseElement, props.ref),
      onKeyDownCapture,
      onKeyUpCapture,
      onFocusCapture,
      onFocus,
    ...
    props = _YAKNSXYIcjs.useFocusable.call(void 0, { focusable, ...props });
    return props;
  }
);
var Composite = _WBFXWJUHcjs.forwardRef.call(void 0, function Composite2(props) {
