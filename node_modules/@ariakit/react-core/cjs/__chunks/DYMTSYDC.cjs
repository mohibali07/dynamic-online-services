...
var _HMZCNR7Fcjs = require('./HMZCNR7F.cjs');
...
var useCompositeItem = _WBFXWJUHcjs.createHook.call(void 0, 
  function useCompositeItem2({
    ...
    const row = _react.useContext.call(void 0, _GCJBB4ZTcjs.CompositeRowContext);
    ...
    const {
      ...
      ariaPosInSet,
      isTabbable
    } = _EMYYI4CZcjs.useStoreStateObject.call(void 0, store, {
      rowId(state) {
    ...
    const onBlurCapture = _MZ2HG624cjs.useEvent.call(void 0, (event) => {
    ...
    const preventScrollOnKeyDownProp = _MZ2HG624cjs.useBooleanEvent.call(void 0, preventScrollOnKeyDown);
    ...
    props = _MZ2HG624cjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _GCJBB4ZTcjs.CompositeItemContext.Provider, { value: providerValue, children: element }),
      [providerValue]
    );
    props = {
      id,
    ...
    props = _HMZCNR7Fcjs.useCommand.call(void 0, props);
    props = _XFOFWDPYcjs.useCollectionItem.call(void 0, {
      store,
      ...props,
      getItem,
...
var CompositeItem = _WBFXWJUHcjs.memo.call(void 0, 
  _WBFXWJUHcjs.forwardRef.call(void 0, function CompositeItem2(props) {
