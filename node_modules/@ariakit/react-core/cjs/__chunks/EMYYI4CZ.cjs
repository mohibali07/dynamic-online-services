...
function useStoreProps(store, props, key, setKey) {
  ...
  const propsRef = _MZ2HG624cjs.useLiveRef.call(void 0, { value, setValue });
...
function useStore(createStore, props) {
  ...
  _MZ2HG624cjs.useSafeLayoutEffect.call(void 0, () => _store.init.call(void 0, store), [store]);
  ...
  const updateStore = _MZ2HG624cjs.useEvent.call(void 0, () => {
