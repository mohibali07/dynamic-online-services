...
function useToolbarStoreProps(store, update, props) {
  return _E4LRYSXNcjs.useCompositeStoreProps.call(void 0, store, update, props);
}
function useToolbarStore(props = {}) {
  const [store, update] = _EMYYI4CZcjs.useStore.call(void 0, Core.createToolbarStore, props);
