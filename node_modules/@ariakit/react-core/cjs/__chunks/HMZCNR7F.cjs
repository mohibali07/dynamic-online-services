...
var useCommand = _WBFXWJUHcjs.createHook.call(void 0, 
  function useCommand2({ clickOnEnter = true, clickOnSpace = true, ...props }) {
    ...
    const [isDuplicate, metadataProps] = _MZ2HG624cjs.useMetadataProps.call(void 0, props, symbol, true);
    ...
    const onKeyUp = _MZ2HG624cjs.useEvent.call(void 0, (event) => {
...
var Command = _WBFXWJUHcjs.forwardRef.call(void 0, function Command2(props) {
