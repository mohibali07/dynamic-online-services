...
var _2MWKJ5UMcjs = require('./2MWKJ5UM.cjs');
...
var useComboboxItem = _WBFXWJUHcjs.createHook.call(void 0, 
  function useComboboxItem2({
    ...
    const { resetValueOnSelectState, multiSelectable, selected } = _EMYYI4CZcjs.useStoreStateObject.call(void 0, store, {
    ...
    const selectValueOnClickProp = _MZ2HG624cjs.useBooleanEvent.call(void 0, selectValueOnClick);
    const resetValueOnSelectProp = _MZ2HG624cjs.useBooleanEvent.call(void 0, 
    ...
    props = _MZ2HG624cjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _2MWKJ5UMcjs.ComboboxItemValueContext.Provider, { value, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _2MWKJ5UMcjs.ComboboxItemCheckedContext.Provider, { value: selected != null ? selected : false, children: element }) }),
      [value, selected]
    );
    const popupRole = _react.useContext.call(void 0, _2MWKJ5UMcjs.ComboboxListRoleContext);
    props = {
    ...
    const moveOnKeyPressProp = _MZ2HG624cjs.useBooleanEvent.call(void 0, moveOnKeyPress);
    ...
    props = _OM7OYSJCcjs.useCompositeHover.call(void 0, { store, focusOnHover, ...props });
    return props;
  }
);
var ComboboxItem = _WBFXWJUHcjs.memo.call(void 0, 
  _WBFXWJUHcjs.forwardRef.call(void 0, function ComboboxItem2(props) {
