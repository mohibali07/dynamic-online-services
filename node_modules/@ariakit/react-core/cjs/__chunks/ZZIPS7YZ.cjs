...
var _JDF6CMNNcjs = require('./JDF6CMNN.cjs');
...
var useFormControl = _WBFXWJUHcjs.createHook.call(void 0, 
  function useFormControl2({
    ...
    const touchOnBlurProp = _MZ2HG624cjs.useBooleanEvent.call(void 0, touchOnBlur);
    ...
    props = _XFOFWDPYcjs.useCollectionItem.call(void 0, { store, ...props, name, getItem });
    return props;
  }
);
var FormControl = _WBFXWJUHcjs.memo.call(void 0, 
  _WBFXWJUHcjs.forwardRef.call(void 0, function FormControl2(props) {
