...
var usePopoverArrow = _WBFXWJUHcjs.createHook.call(void 0, 
  function usePopoverArrow2({
    ...
    const context = _QXXNZT2Icjs.usePopoverContext.call(void 0, );
    store = store || context;
    ...
    const maskId = _MZ2HG624cjs.useId.call(void 0, );
    ...
    props = {
      ...
      "aria-hidden": true,
      ...props,
      ref: _MZ2HG624cjs.useMergeRefs.call(void 0, store.setArrowElement, props.ref),
      style: {
        position: "absolute",
        fontSize: size,
        width: "1em",
...
var PopoverArrow = _WBFXWJUHcjs.memo.call(void 0, 
  _WBFXWJUHcjs.forwardRef.call(void 0, function PopoverArrow2(props) {
