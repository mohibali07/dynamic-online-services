...
var _5RHEK3U2cjs = require('./5RHEK3U2.cjs');
...
function findById(items, id, baseId) {
  return items.findIndex((item, index) => {
    var _a;
    const itemId = _5RHEK3U2cjs.getCollectionRendererItemId.call(void 0, item, index, baseId);
...
function useCompositeRenderer({
  ...
  store = store || context;
  const orientation = _EMYYI4CZcjs.useStoreState.call(void 0, 
    store,
  ...
  const activeId = _EMYYI4CZcjs.useStoreState.call(void 0, store, "activeId");
  ...
  return _5RHEK3U2cjs.useCollectionRenderer.call(void 0, {
    id,
    store,
    orientation,
    persistentIndices,
...
var CompositeRenderer = _WBFXWJUHcjs.forwardRef.call(void 0, function CompositeRenderer2(props) {
