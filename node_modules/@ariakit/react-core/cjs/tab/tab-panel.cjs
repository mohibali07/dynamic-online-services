...
var _NROAA37Vcjs = require('../__chunks/NROAA37V.cjs');


var _YZWMAQPAcjs = require('../__chunks/YZWMAQPA.cjs');


var _WT6V7PQBcjs = require('../__chunks/WT6V7PQB.cjs');


var _XFOFWDPYcjs = require('../__chunks/XFOFWDPY.cjs');
require('../__chunks/5WCU5NVK.cjs');
require('../__chunks/57Z4CQLB.cjs');
require('../__chunks/GCJBB4ZT.cjs');


var _YAKNSXYIcjs = require('../__chunks/YAKNSXYI.cjs');
...
var TagName = "div";
var useTabPanel = _WBFXWJUHcjs.createHook.call(void 0, 
  function useTabPanel2({
    ...
    const context = _NROAA37Vcjs.useTabProviderContext.call(void 0, );
    store = store || context;
    ...
    const tabId = _EMYYI4CZcjs.useStoreState.call(void 0, 
      store.panels,
      () => {
        var _a;
    ...
    const open = _EMYYI4CZcjs.useStoreState.call(void 0, 
      store,
      (state) => !!tabId && state.selectedId === tabId
    );
    const disclosure = _WT6V7PQBcjs.useDisclosureStore.call(void 0, { open });
    const mounted = _EMYYI4CZcjs.useStoreState.call(void 0, disclosure, "mounted");
    const scrollPositionRef = _react.useRef.call(void 0, 
      /* @__PURE__ */ new Map()
    );
    const getScrollElement = _MZ2HG624cjs.useEvent.call(void 0, () => {
    ...
    props = _MZ2HG624cjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _NROAA37Vcjs.TabScopedContextProvider, { value: store, children: element }),
      [store]
    );
    props = {
      id,
    ...
    props = _YAKNSXYIcjs.useFocusable.call(void 0, {
      // If the tab panel is rendered as part of another composite widget such
      // as combobox, it should not be focusable.
      focusable: !store.composite && !hasTabbableChildren,
      ...props
    });
    props = _YZWMAQPAcjs.useDisclosureContent.call(void 0, { store: disclosure, ...props });
    props = _XFOFWDPYcjs.useCollectionItem.call(void 0, { store: store.panels, ...props, getItem });
    return props;
  }
);
var TabPanel = _WBFXWJUHcjs.forwardRef.call(void 0, function TabPanel2(props) {
