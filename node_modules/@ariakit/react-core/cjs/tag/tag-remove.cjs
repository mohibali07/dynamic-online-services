...
var _AGBM3YM2cjs = require('../__chunks/AGBM3YM2.cjs');
...
var TagName = "button";
var useTagRemove = _WBFXWJUHcjs.createHook.call(void 0, 
  function useTagRemove2({
    ...
    const context = _AGBM3YM2cjs.useTagContext.call(void 0, );
    store = store || context;
    ...
    const setRemoveId = _react.useContext.call(void 0, _AGBM3YM2cjs.TagRemoveIdContext);
    const valueFromContext = _react.useContext.call(void 0, _AGBM3YM2cjs.TagValueContext);
    ...
    const removeOnClickProp = _MZ2HG624cjs.useBooleanEvent.call(void 0, removeOnClick);
    ...
    props = {
      ...
      ...props,
      onClick,
      render: withinTag ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _DMTXWFDQcjs.Role.span, { render: props.render }) : props.render
    };
    return props;
  }
);
var TagRemove = _WBFXWJUHcjs.forwardRef.call(void 0, function TagRemove2(props) {
