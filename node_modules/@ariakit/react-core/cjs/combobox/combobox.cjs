...
var _LJMK4VH7cjs = require('../__chunks/LJMK4VH7.cjs');
...
var useCombobox = _WBFXWJUHcjs.createHook.call(void 0, 
  function useCombobox2({
    ...
    const [valueUpdated, forceValueUpdate] = _MZ2HG624cjs.useForceUpdate.call(void 0, );
    ...
    _MZ2HG624cjs.useUpdateLayoutEffect.call(void 0, () => {
      if (!inline) return;
      setCanInline(true);
    }, [inline]);
    ...
    const getAutoSelectIdProp = _MZ2HG624cjs.useEvent.call(void 0, getAutoSelectId);
    ...
    _MZ2HG624cjs.useUpdateEffect.call(void 0, () => {
      var _a, _b;
    ...
    const showOnChangeProp = _MZ2HG624cjs.useBooleanEvent.call(void 0, showOnChange != null ? showOnChange : canShow);
    const setValueOnChangeProp = _MZ2HG624cjs.useBooleanEvent.call(void 0, 
    ...
    const onCompositionEnd = _MZ2HG624cjs.useEvent.call(void 0, (event) => {
      canAutoSelectRef.current = true;
    ...
    const blurActiveItemOnClickProp = _MZ2HG624cjs.useBooleanEvent.call(void 0, 
      blurActiveItemOnClick != null ? blurActiveItemOnClick : (() => !!(store == null ? void 0 : store.getState().includesBaseElement))
    );
    const setValueOnClickProp = _MZ2HG624cjs.useBooleanEvent.call(void 0, setValueOnClick);
    const showOnClickProp = _MZ2HG624cjs.useBooleanEvent.call(void 0, showOnClick != null ? showOnClick : canShow);
    const onMouseDown = _MZ2HG624cjs.useEvent.call(void 0, (event) => {
    ...
    const showOnKeyPressProp = _MZ2HG624cjs.useBooleanEvent.call(void 0, showOnKeyPress != null ? showOnKeyPress : canShow);
    ...
    props = _64BKHVGOcjs.useComposite.call(void 0, {
      store,
      focusable,
      ...props,
    ...
    props = _LJMK4VH7cjs.usePopoverAnchor.call(void 0, { store, ...props });
    return { autoComplete: "off", ...props };
  }
);
var Combobox = _WBFXWJUHcjs.forwardRef.call(void 0, function Combobox2(props) {
