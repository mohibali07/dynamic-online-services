...
var _NUG2M4ODcjs = require('../__chunks/NUG2M4OD.cjs');
...
function useCompositeOverflowStoreProps(store, update, props) {
  return _NUG2M4ODcjs.usePopoverStoreProps.call(void 0, store, update, props);
}
function useCompositeOverflowStore(props = {}) {
  const [store, update] = _EMYYI4CZcjs.useStore.call(void 0, Core.createCompositeOverflowStore, props);
