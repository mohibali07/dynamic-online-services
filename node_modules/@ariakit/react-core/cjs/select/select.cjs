...
var _MZ5ZDSBWcjs = require('../__chunks/MZ5ZDSBW.cjs');



var _6DC6MIBCcjs = require('../__chunks/6DC6MIBC.cjs');
require('../__chunks/M4UZFGFK.cjs');
...
var useSelect = _WBFXWJUHcjs.createHook.call(void 0, function useSelect2({
  store,
  name,
  form,
  required,
  ...
  const context = _6DC6MIBCcjs.useSelectProviderContext.call(void 0, );
  store = store || context;
  ...
  const showOnKeyDownProp = _MZ2HG624cjs.useBooleanEvent.call(void 0, showOnKeyDown);
  const moveOnKeyDownProp = _MZ2HG624cjs.useBooleanEvent.call(void 0, moveOnKeyDown);
  ...
  props = _MZ2HG624cjs.useWrapElement.call(void 0, 
    props,
    (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _6DC6MIBCcjs.SelectScopedContextProvider, { value: store, children: element }),
    [store]
  );
  ...
  const children = /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
    value,
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _MZ5ZDSBWcjs.SelectArrow, {})
  ] });
  ...
  props = {
    ...
    children,
    ...props,
    ref: _MZ2HG624cjs.useMergeRefs.call(void 0, store.setSelectElement, props.ref),
    onKeyDown
  };
  props = _FYIGTOVUcjs.usePopoverDisclosure.call(void 0, { store, toggleOnClick, ...props });
  props = _OJGWGKHTcjs.useCompositeTypeahead.call(void 0, { store, ...props });
  return props;
});
var Select = _WBFXWJUHcjs.forwardRef.call(void 0, function Select2(props) {
