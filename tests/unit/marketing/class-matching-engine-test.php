...
require_once dirname(__DIR__, 3) . '/includes/marketing/class-matching-engine.php';
// Attempt to load Options class if exists
if (file_exists(dirname(__DIR__, 3) . '/includes/helpers/class-options.php')) {
    require_once dirname(__DIR__, 3) . '/includes/helpers/class-options.php';
}
if (file_exists(dirname(__DIR__, 3) . '/includes/settings/class-defaults.php')) {
    require_once dirname(__DIR__, 3) . '/includes/settings/class-defaults.php';
}
